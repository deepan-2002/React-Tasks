    ...
    return (
        <main className="fruits">
            ...
            <div className="container d-flex flex-row justify-content-around rounded w-75">
                <div className="grape">
                    <img src="https://freepngimg.com/thumb/grapes/134710-vector-black-grapes-download-hq.png" alt="Grapes" width={'200px'} /><br/>
                    <button className="btn btn-success" onClick={() => { setGrape(grape + 1) }}>Eat Grape</button>
                </div>
                <div className="apple">
                    <img src="https://pngimg.com/d/apple_PNG12491.png" alt="Apple" width={'200px'} /><br/>
